...
/**
 * Created by Debasis on 04-11-2016.
 */
...
public class GaugeView extends View {
    ...
    public static final boolean SHOW_TEXTS = false;
    ...
    public static final int INNER_CIRCLE_COLOR = Color.rgb(186, 0, 229);//Color.rgb(190, 215, 123);
    public static final int OUTER_CIRCLE_COLOR = Color.rgb(211, 0, 229);//Color.rgb(205, 231, 132);
    ...
    public static final float[] RANGE_VALUES = {18.0f, 25.0f, 30.0f, 100.0f};
    public static final int[] RANGE_COLORS = {Color.rgb(0, 0, 0), Color.rgb(0, 0, 0), Color.rgb(0, 0, 0), Color.rgb(0, 0, 0)};
    //Color.rgb(0, 102, 204), Color.rgb(0, 204, 102), Color.rgb(255, 204, 51), Color.rgb(255, 61, 61),Color.rgb(255, 0, 0)
    ...
    private void readAttrs(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        mShowTexts = a.getBoolean(R.styleable.GaugeView_showTexts, SHOW_TEXTS);
    ...
    public Paint getDefaultNeedleScrewPaint() {
        final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
        paint.setShader(new RadialGradient(0.5f, 0.5f, 0.04f, new int[]{Color.rgb(181, 181, 181), Color.WHITE}, new float[]{0.05f, 0.9f}, TileMode.MIRROR));
        paint.setColor(Color.rgb(244, 244, 244));
        return paint;
    }
    ...
    public void setDefaultRanges() {
        mRangeValues = new float[]{18, 25, 30, 40, 100};
        mRangeColors = new int[]{Color.rgb(231, 32, 43), Color.rgb(232, 111, 33), Color.rgb(232, 231, 33), Color.rgb(232, 231, 33), Color.rgb(27, 202, 33)};
    }
...
private void drawScale(final Canvas canvas) {
    ...
    private void drawNeedle(final Canvas canvas) {
        if (mNeedleInitialized) {
            ...
            innerCircle.setShader(new RadialGradient(0.5f, 0.5f, 0.04f, new int[]{ Color.WHITE, Color.rgb(233,233,233)}, new float[]{0.04f, 0.9f}, TileMode.CLAMP));
            ...
            canvas.drawCircle(0.5f, 0.5f, 0.03f, mNeedleScrewPaint);
