 ...
 *
 * <p>
 * Principal Component Analysis (PrincipleComponentAnalysis) is typically used to develop a linear model for a set of data
 * (e.g. face images) which can then be used to test for membership.  PrincipleComponentAnalysis works by converting the
 * set of data to a new basis that is a subspace of the original set.  The subspace is selected
 * to maximize information.
 * </p>
 * <p>
 * PrincipleComponentAnalysis is typically derived as an eigenvalue problem.  However in this implementation {@link org.ejml.interfaces.decomposition.SingularValueDecomposition SVD}
...
public class PrincipleComponentAnalysis
{
    ...
    /**
     * Returns a vector from the PrincipleComponentAnalysis's basis.
     *
     * @param which Which component's vector is to be returned.
     * @return Vector from the PrincipleComponentAnalysis basis.
     */
